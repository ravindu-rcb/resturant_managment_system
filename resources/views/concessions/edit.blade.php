...
<div class="page-header">
  <div class="container">
    <h1 class="page-title">Edit Concession</h1>
    <p class="page-subtitle">Update your concession item details</p>
  </div>
</div>
    ...
    <div class="col-md-8 col-lg-6">
      <div class="card form-card">
        <div class="form-header">
          ...
          <h2 class="form-title">Edit Concession Item</h2>
        </div>

        <div class="form-body">
          <form method="post" enctype="multipart/form-data" action="{{ route('concessions.update',$concession) }}" id="editForm">
            @csrf @method('PUT')
            ...
            <div class="form-group">
              ...
              <textarea name="description" class="form-control" rows="4"
                        placeholder="Describe your concession item">{{ old('description',$concession->description) }}</textarea>
            </div>
            ...
            <div class="form-group">
              ...
              @if($concession->image_path)
                <div class="current-image">
                  <img src="{{ asset('storage/'.$concession->image_path) }}" alt="Current image" class="current-image-preview">
            ...
            <div class="form-group">
              ...
              <input type="number" step="0.01" min="0" name="price" class="form-control" required
                     value="{{ old('price',$concession->price) }}" placeholder="0.00">
              @error('price')
                <div class="error-message">
                  <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                </div>
            ...
            <div class="d-flex btn-group">
              <button type="submit" class="btn btn-update flex-fill">
                <i class="fas fa-save me-2"></i>Update Concession
              </button>
